                    ...
                    public void mouseClicked(MouseEvent e) {
                      // play sound 
                        ...
                        if (GamePanel.canPlaySound) {
                            mySoundPlayer.playSound("C:\\Users\\LeVy\\IdeaProjects\\Caro Chest\\sound\\kick.mp3");
                        }
            ...
            while (true) {
                ...
                if (response.startsWith("VALID_MOVE")) {
                    ...
                    messageLabel.setText("Đối thủ đã đi , đến lượt bạn");
                       ...
                       // âm thanh 
                    if (GamePanel.canPlaySound) {
                        mySoundPlayer.playSound("C:\\Users\\LeVy\\IdeaProjects\\Caro Chest\\sound\\win.mp3");
                    }
                    
                    // bảng thông báo
                    Icon myIcon = new ImageIcon(getClass().getResource("picture/winner" + (mark == 'X' ? '1' : '2') + ".png"));
                    ...
                    // âm thanh 
                    if (GamePanel.canPlaySound) {
                        mySoundPlayer.playSound("C:\\Users\\LeVy\\IdeaProjects\\Caro Chest\\sound\\GameOver.mp3");
                    }
                    
                    // bảng thông báo
                    Icon myIcon = new ImageIcon(getClass().getResource("picture/loser" + (mark == 'X' ? '1' : '2') + ".png"));
